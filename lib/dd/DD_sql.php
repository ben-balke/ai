...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/lib/dd/DD_sql.php,v 1.5 2016/03/08 23:24:30 secwind Exp $
*************************************************************************/
...
class DD_SqlConnection
{
	...
	function DD_SqlConnection ($name, $host, $user, $pass, $db)
	{
		$this->m_name = $name;
		$this->m_host = $host;
		$this->m_user = $user;
...
class DD_MySqlConnection extends DD_SqlConnection
{
	 ...
	 */
	function DD_MySqlConnection ($array)
	{
		parent::DD_SqlConnection (
			$array ['name'],
			$array['host'],
			$array['user'], 
			$array ['pass'], 
	...
	//function DD_MySqlConnection ($name, $host, $user, $pass, $db)
	//{
		//parent::DD_SqlConnection ($name, $host, $user, $pass, $db);
	//}
	function connect ()
	{
...
class DD_PgSqlConnection extends DD_SqlConnection
{
	 ...
	 * Establishes a SQL Connection from a named array.
	 */
	function DD_PgSqlConnection ($array)
	{
		parent::DD_SqlConnection (
			$array ['name'],
			$array['host'],
...
class DD_PDOConnection extends DD_SqlConnection
{
	 ...
	 * Establishes a SQL Connection from a named array.
	 */
	function DD_PDOConnection ($array)
	{
		parent::DD_SqlConnection (
			$array ['name'],
			$array['host'],
