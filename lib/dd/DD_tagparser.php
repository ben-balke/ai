...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/lib/dd/DD_tagparser.php,v 1.8 2016/03/08 23:25:19 secwind Exp $
*************************************************************************/
...
class DD_ValueProvider
{
	...
	function DD_ValueProvider ($name)
	{
		$this->m_name = $name;
	}
...
{
	var				$m_array;
	function DD_ArrayValueProvider ($name, $array)
	{
...
$vp2 = new DD_ArrayValueProvider ("rh", array ());
$vp2->setValue ("id", 66);
...
$sql = <<<SQL
insert into ben values ({#%ben.id}, {SQL:rh.name})
SQL;
