...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/kpi/querybylob.php,v 1.3 2012/08/28 21:14:33 secwind Exp $
*************************************************************************/
...
$page->makeField (array ('name'=>'caption', 'default'=>'{dd:kpi.kpi_desc} by Performance Group'));
$page->makeField (array ('name'=>'codetitle', 'default'=>'Code'));
$page->makeField (array ('name'=>'desctitle', 'default'=>'Performance Group'));
$page->makeField (array ('name'=>'sort_property_name', 'default'=>'sort_bylob'));
$page->makeField (array ('name'=>'link', 'default'=>'kpi/queryforlob.php?daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'xmllink', 'default'=>'kpi/querybylob.php/{dd:http.kpi_type}_lineofbusiness.xml?xml=true&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'csvlink', 'default'=>'kpi/querybylob.php/{dd:http.kpi_type}_lineofbusiness.csv?csv=true&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'list_filter', 'default'=>'daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}&kpi_group'));
