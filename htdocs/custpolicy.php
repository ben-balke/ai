...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/custpolicy.php,v 1.5 2009/10/28 19:01:54 secwind Exp $
*************************************************************************/
...
require_once 'ai/widgets/PolicyInfo.php';
...
<body>
{dd:ai.bodyhead}
<a href="{dd:dd.path}sagitta/premiums.php?id={dd:http.policy_id}">Premiums</a> |
<a href="{dd:dd.path}sagitta/policy.php?id={dd:http.policy_id}">Policy</a>
...
$page->addField (new PolicyInfo ('policy'));
