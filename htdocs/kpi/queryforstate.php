...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/kpi/queryforstate.php,v 1.3 2012/08/28 21:14:33 secwind Exp $
*************************************************************************/
...
$page->makeField (array ('name'=>'xmllink', 'default'=>'kpi/queryforstate.php/{dd:hdr.kpi_prefix}_{dd:http.daterange}_{dd:%hdr.itemname}_by_{dd:user.tab_forstate}.xml?kpi_type={dd:http.kpi_type}&daterange={dd:http.daterange}&id={dd:http.id}&xml=true'));
$page->makeField (array ('name'=>'csvlink', 'default'=>'kpi/queryforstate.php/{dd:hdr.kpi_prefix}_{dd:http.daterange}_{dd:%hdr.itemname}_by_{dd:user.tab_forstate}.csv?kpi_type={dd:http.kpi_type}&daterange={dd:http.daterange}&id={dd:http.id}&csv=true'));

$page->makeField (array ('name'=>'list_filter','default'=>'state={dd:%http.id}&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}&' . $page->get ('filter_arg')));
$page->makeField (array ('name'=>'total_filter','default'=>'state={dd:%http.id}&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
