...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/lib/2d/DD_sqljson.php,v 1.1 2016/02/16 21:18:00 secwind Exp $
*************************************************************************/

require_once '2d/DD_sql.php';
require_once '2d/DD_json.php';
class DD_SqlJson
{
	var			$m_select;
	var			$m_connect;
	...
	function getJson ($tagParser = null)
	{
		...
		{
			die ("DD_SqlJason::query(): Cannot find connection string" . $this->m_connect);
		}
		if (isset ($tagParser))
		{
