...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/servicer.php,v 1.2 2009/10/28 19:01:54 secwind Exp $
*************************************************************************/
...
$page->prepare();
$newLoc = $page->m_tp->parseContent ('Location: {dd:dd.path}queryforcsr.php?id={dd:%http.id}');
header($newLoc);
?>
