...
class REPORT_Page extends AI_Page
{
	var			$m_seriesMax = 7;
	function REPORT_page ($name, $currentMenuName)
	{
...
{dd:-user.graphs}<tr>
{dd:-user.graphs}	<td align="center">Premium Break Down<br/><img alt="" width="325" height="200" src="{dd:dd.path}piechart.php/image.png?graphid={dd:page.premium_graphid}" usemap="#{dd:page.premium_graphid}"/></td>
{dd:-user.graphs}	<td align="center">Revenue Break Down<br/><img alt="" width="325" height="200" src="{dd:dd.path}piechart.php/image.png?graphid={dd:page.revenue_graphid}" usemap="#{dd:page.revenue_graphid}"/></td>
{dd:-user.graphs}</tr>
</table>
