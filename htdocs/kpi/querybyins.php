...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/kpi/querybyins.php,v 1.3 2012/08/28 21:14:33 secwind Exp $
*************************************************************************/
...
$page->makeField (array ('name'=>'caption', 'default'=>'{dd:kpi.kpi_desc} by Insuror'));
...
$page->makeField (array ('name'=>'link', 'default'=>'kpi/queryforins.php?daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'xmllink', 'default'=>'kpi/querybyins.php/{dd:http.kpi_type}_insurors.xml?xml=true&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'csvlink', 'default'=>'kpi/querybyins.php/{dd:http.kpi_type}_insurors.csv?csv=true&daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}'));
$page->makeField (array ('name'=>'list_filter', 'default'=>'daterange={dd:http.daterange}&kpi_type={dd:http.kpi_type}&insuror_id'));
