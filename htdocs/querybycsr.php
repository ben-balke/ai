...
** Author: Ben Balke
** $Header: /home/cvsroot/ai/htdocs/querybycsr.php,v 1.4 2012/08/28 21:13:55 secwind Exp $
*************************************************************************/
...
$page->makeField (array ('name'=>'caption', 'default'=>'Book by Servicer'));
$page->makeField (array ('name'=>'codetitle', 'default'=>'Code'));
$page->makeField (array ('name'=>'desctitle', 'default'=>'Servicer'));
$page->makeField (array ('name'=>'link', 'default'=>'queryforcsr.php'));
$page->makeField (array ('name'=>'sort_property_name', 'default'=>'sort_bycsr'));
$page->makeField (array ('name'=>'xmllink', 'default'=>'querybycsr.php/servicers.xml?xml=true'));
$page->makeField (array ('name'=>'csvlink', 'default'=>'querybycsr.php/servicers.csv?csv=true'));
$page->makeField (array ('name'=>'list_filter', 'type'=>'work','value'=>'servicer_id'));
...
if (isset ($_GET ['xml']))
	...
	$page->renderCSV (array ('select'=>$select));
else
